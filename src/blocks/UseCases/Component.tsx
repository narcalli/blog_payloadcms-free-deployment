  ...
  return (
    <section className="ncx-usecases">
      <style>{`
        ...
        .ncx-usecases{--ink:#16203A;--soft:#4A5573;--crimson:#E0245E;--rule:#DFE3EA;--paper:#F6F7F9;
          background:var(--paper);padding:48px 0;font-family:"Source Serif 4",Georgia,serif;color:var(--ink)}
        .ncx-usecases .inner{max-width:1120px;margin:0 auto;padding:0 32px}
        .ncx-usecases .label{font-family:"Bricolage Grotesque",system-ui,sans-serif;font-size:14px;
          color:var(--crimson);margin:0 0 12px}
        .ncx-usecases h2{font-family:"Bricolage Grotesque",system-ui,sans-serif;font-weight:500;
        ...
        .ncx-usecases .sector{font-family:"Bricolage Grotesque",system-ui,sans-serif;font-size:13px;
          color:var(--soft);margin:0 0 10px}
        .ncx-usecases h3{font-family:"Bricolage Grotesque",system-ui,sans-serif;font-weight:500;
        ...
        .ncx-usecases .outcome{margin:18px 0 0;padding-top:16px;border-top:1px solid var(--rule);
          font-family:"Bricolage Grotesque",system-ui,sans-serif;font-size:15px;color:var(--ink)}
