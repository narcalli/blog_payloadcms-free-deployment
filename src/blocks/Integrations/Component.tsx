  ...
  return (
    <section className="ncx-integrations">
      <style>{`
        ...
        .ncx-integrations{--ink:#16203A;--soft:#4A5573;--crimson:#E0245E;--rule:#DFE3EA;--paper:#F6F7F9;
          max-width:1120px;margin:0 auto;padding:48px 32px;
          font-family:"Source Serif 4",Georgia,serif;color:var(--ink)}
        .ncx-integrations .label{font-family:"Bricolage Grotesque",system-ui,sans-serif;font-size:14px;
          color:var(--crimson);margin:0 0 12px}
        .ncx-integrations h2{font-family:"Bricolage Grotesque",system-ui,sans-serif;font-weight:500;
        ...
        .ncx-integrations .initial{font-family:"Bricolage Grotesque",system-ui,sans-serif;font-size:15px;
          font-weight:500;color:var(--soft)}
        .ncx-integrations .name{font-family:"Bricolage Grotesque",system-ui,sans-serif;font-size:16px;
