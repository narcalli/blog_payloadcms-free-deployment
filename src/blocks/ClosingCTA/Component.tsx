...
export const ClosingCtaBlock: React.FC<Props> = ({
  ...
  <section className="ncx-closing">
    <style>{`
      ...
      .ncx-closing{--ink:#16203A;--crimson:#E0245E;background:var(--ink);color:#fff;
        font-family:"Source Serif 4",Georgia,serif}
      .ncx-closing .inner{max-width:1120px;margin:0 auto;padding:72px 32px;text-align:center}
      .ncx-closing h2{font-family:"Bricolage Grotesque",system-ui,sans-serif;font-weight:500;
      ...
      .ncx-closing .btn{font-family:"Bricolage Grotesque",system-ui,sans-serif;font-size:15px;
