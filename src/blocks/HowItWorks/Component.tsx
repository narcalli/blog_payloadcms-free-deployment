...
export const HowItWorksBlock: React.FC<Props> = ({
  ...
  return (
    <section className="ncx-how">
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,500;12..96,700&family=Source+Serif+4:opsz,wght@8..60,400&display=swap');
        .ncx-how{--ink:#16203A;--soft:#4A5573;--crimson:#E0245E;--rule:#DFE3EA;--paper:#F6F7F9;
          max-width:1120px;margin:0 auto;padding:64px 32px;
          font-family:"Source Serif 4",Georgia,serif;color:var(--ink);border-top:1px solid var(--rule)}
        .ncx-how .label{font-family:"Bricolage Grotesque",system-ui,sans-serif;font-size:14px;
          color:var(--crimson);margin:0 0 12px}
        .ncx-how h2{font-family:"Bricolage Grotesque",system-ui,sans-serif;font-weight:500;
        ...
        .ncx-how .num{font-family:"Bricolage Grotesque",system-ui,sans-serif;font-weight:700;
          font-size:14px;color:var(--crimson);display:block;margin-bottom:14px;
          padding-bottom:14px;border-bottom:1px solid var(--rule)}
        .ncx-how h3{font-family:"Bricolage Grotesque",system-ui,sans-serif;font-weight:500;
        ...
        .ncx-how .btn{font-family:"Bricolage Grotesque",system-ui,sans-serif;font-size:15px;
