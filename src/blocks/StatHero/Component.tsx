  ...
  return (
    <section className="ncx-stathero">
      <style>{`
        ...
        .ncx-stathero{--ink:#16203A;--soft:#4A5573;--crimson:#E0245E;--violet:#6E5BF2;
        ...
        .ncx-stathero .g2{width:520px;height:520px;left:4%;top:40px;opacity:.22;
          background:radial-gradient(circle,rgba(224,36,94,.8),transparent 65%)}
        ...
        .ncx-stathero .pill{display:inline-flex;align-items:center;gap:9px;
          font-family:"Bricolage Grotesque",system-ui,sans-serif;font-size:13px;color:var(--soft);
        ...
        .ncx-stathero .btn{font-family:"Bricolage Grotesque",system-ui,sans-serif;font-size:15px;
        ...
        .ncx-stathero .value{font-family:"Bricolage Grotesque",system-ui,sans-serif;font-weight:700;
          font-size:34px;letter-spacing:-.03em;
          background:linear-gradient(135deg,var(--violet),var(--cyan));
          -webkit-background-clip:text;background-clip:text;color:transparent}
        .ncx-stathero .slabel{font-family:"Bricolage Grotesque",system-ui,sans-serif;font-size:13px;
